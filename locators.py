...
LOGIN_IN_RECOVERY = (By.XPATH,"//a[text()='Войти']")  # Вход через форму восстановления пароля
...
LOG_IN = (By.XPATH, "//a[text()= 'Войти']")  # Переход из формы регистрации обратно в форму входа
