...
from locators import EMAIL_BUTTON, PASSWORD_BUTTON, REGISTRATION_BUTTON, MY_ACCOUNT, NAME_BUTTON
import random
...
wait.until(EC.visibility_of_element_located(NAME_BUTTON))
...
driver.find_element(*REGISTRATION_BUTTON).click()
wait.until(
    EC.visibility_of_element_located(EMAIL_BUTTON)
)
driver.quit()